...
function ListProducts() {
    ...
    return (
        <>
            <div className='d-flex justify-content-between align-items-center m-5' ><button className='btn btn-lg btn-info text-light' onClick={() => navigate('/seller')}><IoArrowBackSharp /></button>
